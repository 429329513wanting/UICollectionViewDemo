...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/RQShineLabel/RQShineLabel.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/SDWebImage/SDWebImage.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/TYAttributedLabel/TYAttributedLabel.framework"
fi
